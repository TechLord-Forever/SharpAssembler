namespace OpcodeWriter.X86
{
    ...
    public class X86OperandSpec : OperandSpec
    {
        ...
        /// or <see cref="OpcodeWriter.X86.Register.None"/> to specify none.
        /// The default is <see cref="OpcodeWriter.X86.Register.None"/>.</value>
        ...
        /// or <see cref="OpcodeWriter.X86.X86OperandType.None"/> to specify none.
        /// The default is <see cref="OpcodeWriter.X86.X86OperandType.None"/>.</value>
        ...
        /// or <see cref="OpcodeWriter.X86.X86OperandEncoding.Default"/> to specify the default.
        /// The default is <see cref="OpcodeWriter.X86.X86OperandEncoding.Default"/>.</value>

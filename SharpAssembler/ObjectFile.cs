...
namespace SharpAssembler
{
        ...
        : IFile, IAssociatable, IAnnotatable, IObjectFileVisitable
    {
        ...
        public ObjectFile(IObjectFileFormat format, IArchitecture architecture, string name)
        {
            ...
            AssociatedSymbol = new Symbol(SymbolType.None, name);
        }
        ...
        public string Name
        {
            get { return associatedSymbol.Identifier; }
            set { associatedSymbol.Identifier = value; }
        }
        ...
        public IObjectFileFormat Format { get; private set; }
        ...
        {
            return associatedSymbol.Identifier ?? base.ToString();
        }

    ...
    partial class EncodedInstruction
    {
        ...
        public class SibByte
        {
            ...
            public byte Base
            {
                get
                {
                    Contract.Ensures(Contract.Result<byte>() <= 0x0F, "Only the first 4 bits may be set.");
                    return @base;
                }
                set
                {
            ...
            public byte Scale
            {
                get
                {
                    Contract.Ensures(Contract.Result<byte>() <= 0x03, "Only the first 2 bits may be set.");
                    return scale;
                }
                set
                {

...
namespace SharpAssembler
{
    ...
    public class SectionCollection : KeyedCollection<string, Section>
    {
        ...
        {
            var section = owner.Format.SectionFactory.CreateSection(type);
            Add(section);
            return section;
        }
        ...
        {
            var section = owner.Format.SectionFactory.CreateSection(type, identifier);
            Add(section);
            return section;
        }

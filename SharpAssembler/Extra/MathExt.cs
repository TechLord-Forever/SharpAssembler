...
namespace SharpAssembler
{
	...
	public static class MathExt
	{
		...
		[Pure]
		[CLSCompliant(false)]
		public static DataSize GetSizeOfValue(ushort value)
		{
			#region Contract
			Contract.Ensures(Enum.IsDefined(typeof(DataSize), Contract.Result<DataSize>()));
			#endregion
		...
		/// <returns>A member of the <see cref="DataSize"/> enumeration.</returns>
		[Pure]
		public static DataSize GetSizeOfValue(int value)
		{
			#region Contract
			Contract.Ensures(Enum.IsDefined(typeof(DataSize), Contract.Result<DataSize>()));
			#endregion
		...
		[Pure]
		[CLSCompliant(false)]
		public static DataSize GetSizeOfValue(uint value)
		{
			#region Contract
			Contract.Ensures(Enum.IsDefined(typeof(DataSize), Contract.Result<DataSize>()));
			#endregion
		...
		[Pure]
		[CLSCompliant(false)]
		public static DataSize GetSizeOfValue(ulong value)
		{
			#region Contract
			Contract.Ensures(Enum.IsDefined(typeof(DataSize), Contract.Result<DataSize>()));
			#endregion

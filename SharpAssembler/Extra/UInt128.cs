...
namespace SharpAssembler
{
        ...
        IComparable, IComparable<UInt128>, IEquatable<UInt128>
    {
        ...
        {
            if (this < int.MinValue || this > int.MaxValue)
                throw new OverflowException();
            return (int)this;
        }
        ...
        {
            if (this < long.MinValue || this > long.MaxValue)
                throw new OverflowException();
            return (long)this;
        }
        ...
        {
            if (this < ushort.MinValue || this > ushort.MaxValue)
                throw new OverflowException();
            return (ushort)this;
        }
        ...
        {
            if (this < uint.MinValue || this > uint.MaxValue)
                throw new OverflowException();
            return (uint)this;
        }
        ...
        {
            if (this < ulong.MinValue || this > ulong.MaxValue)
                throw new OverflowException();
            return (ulong)this;
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            if (formatID == 'x' || formatID == 'X')
            {
                ...
                int.TryParse(format.Substring(1).Trim(), out minimumDigitCount);
        ...
        private string ToHexadecimalString(int minimumDigitCount, bool uppercase)
        {
            ...
            var formatID = uppercase ? "X" : "x";

            int highDigitCount = Math.Max(minimumDigitCount - 16, 0);
            int lowDigitCount = Math.Min(minimumDigitCount, 16);

            if (high != 0 || highDigitCount > 0)
            {
                sb.Append(high.ToString(formatID + highDigitCount.ToString()));
            }

            sb.Append(low.ToString(formatID + lowDigitCount.ToString()));

...
namespace SharpAssembler.Architectures.X86
{
    partial class Instr
    {
        ...
        /// <returns>The created instruction.</returns>
        [CLSCompliant(false)]
        public static X86Instruction Adc(EffectiveAddress destination, sbyte source)
        {
            return X86Opcode.Adc.CreateInstruction(destination, new Immediate(source, DataSize.Bit8));
        }
        ...
        /// <returns>The created instruction.</returns>
        [CLSCompliant(false)]
        public static X86Instruction Adc(EffectiveAddress destination, uint source)
        {
            return X86Opcode.Adc.CreateInstruction(destination, new Immediate(source, DataSize.Bit32));
        }
        ...
        /// <returns>The created instruction.</returns>
        public static X86Instruction Adc(Register destination, Register source)
        {
            return X86Opcode.Adc.CreateInstruction(new RegisterOperand(destination), new RegisterOperand(source));
        }
